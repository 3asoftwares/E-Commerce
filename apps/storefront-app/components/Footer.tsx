...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-black via-gray-700 to-white-950 text-white relative overflow-hidden">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg">
                <img
                  src={
                    'https://res.cloudinary.com/dpdfyou3r/image/upload/v1767265363/3A_gczh29.png'
                  }
                  alt={'3A Softwares'}
