          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <div>
                ...
                <p className="text-sm ml-7">
                  Shipping costs are calculated based on your location and the shipping method selected 
                  at checkout. Orders over ₹500 qualify for free standard shipping.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                ...
                <p className="text-sm ml-7">
                  Delivery times are estimates and may vary due to carrier delays, weather conditions, 
                  or other factors beyond our control. Tracking information is provided for all shipments.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Once shipped, you'll get an email with your tracking number and carrier information.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Use your tracking number on our website or the carrier's site to monitor delivery progress.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Please contact us immediately if you need to change your address. We can update it if the order 
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Yes, we ship to PO boxes using USPS. However, express shipping may not be available for PO box addresses.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What if my package is lost or damaged?</h3>
              <p className="text-sm text-gray-600">
                All shipments are insured. If your package is lost or arrives damaged, contact us within 48 hours 
